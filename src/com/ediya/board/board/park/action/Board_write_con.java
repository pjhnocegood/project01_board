 ...
 */
@WebServlet("/board_write_park.do")
public class Board_write_con extends HttpServlet {
	...
	protected void doPre(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dis = request.getRequestDispatcher("./board/park/board_write_park.jsp");
